...
T = TypeVar("T", bound="HistorySuccessResponse")


@attr.s(auto_attribs=True)
class HistorySuccessResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        history_success_response.additional_properties = d
        return history_success_response
