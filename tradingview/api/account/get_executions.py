...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/accounts/{accountId}/executions".format(client.base_url, accountId=account_id)
...
) -> Optional[Union["ErrorResponse", "ExecutionsResponse"]]:
    if response.status_code == HTTPStatus.OK:

        def _parse_response_200(data: object) -> Union["ErrorResponse", "ExecutionsResponse"]:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_type_0 = ExecutionsResponse.from_dict(data)
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union["ErrorResponse", "ExecutionsResponse"]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union['ErrorResponse', 'ExecutionsResponse']
    """
