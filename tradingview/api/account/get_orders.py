...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union["ErrorResponse", "OrdersResponse"]]:
    if response.status_code == HTTPStatus.OK:

        def _parse_response_200(data: object) -> Union["ErrorResponse", "OrdersResponse"]:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_type_0 = OrdersResponse.from_dict(data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union["ErrorResponse", "OrdersResponse"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: AuthenticatedClient,
    locale: Locale,
) -> Response[Union["ErrorResponse", "OrdersResponse"]]:
    """Orders
...
def sync(
    ...
    *,
    client: AuthenticatedClient,
    locale: Locale,
) -> Optional[Union["ErrorResponse", "OrdersResponse"]]:
    """Orders
    ...
    Returns:
        Union['ErrorResponse', 'OrdersResponse']
    """
