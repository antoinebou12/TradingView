...
) -> Optional[Union["ErrorResponse", "PermissionsResponse"]]:
    if response.status_code == HTTPStatus.OK:

        def _parse_response_200(data: object) -> Union["ErrorResponse", "PermissionsResponse"]:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_type_0 = PermissionsResponse.from_dict(data)
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union["ErrorResponse", "PermissionsResponse"]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union['ErrorResponse', 'PermissionsResponse']
    """
