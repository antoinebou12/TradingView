...
from ...models.modify_position_data import ModifyPositionData
...
def _get_kwargs(
    ...
    *,
    ...
    form_data: ModifyPositionData,
    locale: Locale,
) -> Dict[str, Any]:
    url = "{}/accounts/{accountId}/positions/{positionId}".format(
        client.base_url, accountId=account_id, positionId=position_id
    )
